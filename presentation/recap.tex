...
\begin{frame}
    ...
    \begin{column}{0.42\textwidth}\begin{minipage}[l][0.8\textheight]{\columnwidth}
        \includegraphics[height=0.18\textheight]{house}
        \vfill
