...
\tikzset{
    ...
    photon/.style={decorate, decoration={snake}, draw},
    electron/.style={draw, postaction={decorate},
        decoration={markings,mark=at position .55 with {\arrow[draw]{>}}}},
    positron/.style={draw, postaction={decorate},
        decoration={markings,mark=at position .55 with {\arrow[draw]{<}}}}
}

\providecommand{\HiggsColor}{black}
\providecommand{\PrimaryZColor}{black}
