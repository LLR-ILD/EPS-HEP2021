...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.38\textwidth, keepaspectratio]{br_estimates_default}
    \includegraphics[width=0.38\textwidth, keepaspectratio]{br_estimates_changed_bbww}
    \caption{
...
\begin{figure}[ht]
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth, keepaspectratio]{toys_default_bb}
    \end{minipage}
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \input{../img/code/bias_table_default.tex}
    \end{minipage}
    \caption{
